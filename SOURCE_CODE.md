...
- `open-hardware-control_3.4.17~intern1_all.deb` – internes Debian/Ubuntu/Linux-Mint-Paket
- `open-hardware-control-3.4.17-0.intern1.noarch.rpm` – internes Fedora/Nobara-Paket

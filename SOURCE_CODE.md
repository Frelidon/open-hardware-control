...
Das Installations-ZIP 3.4.29.45 enthält den direkt editierbaren Python-Quellcode einschließlich `desktop_shell.py`, `desktop_assets.py` und `desktop_designs.py`:
...
- `open-hardware-control_3.4.29.45_all.deb` – Debian/Ubuntu/Linux-Mint-Paket
- `open-hardware-control-3.4.29.45-1.noarch.rpm` – Fedora/Nobara-Paket
- `open-hardware-control-3.4.29.45-source.tar.gz` – vollständiger Quellcode-Snapshot
- `Entwicklerpaket 3.4.29.45.zip` – vollständiger editierbarer Projektbaum einschließlich Tests, Werkzeuge und GitHub-Automatisierung
- `Open_Hardware_Control_3.4.29.45_LOCAL_AI.gitbundle` – vollständige Git-Historie für lokale KI-Arbeit

...
Das interne Installations-ZIP 3.4.29.2 enthält den direkt editierbaren Python-Quellcode einschließlich `desktop_shell.py`, `desktop_assets.py` und `desktop_designs.py`:
...
- `open-hardware-control_3.4.29.2~intern2_all.deb` – internes Debian/Ubuntu/Linux-Mint-Paket
- `open-hardware-control-3.4.29.2-0.intern2.noarch.rpm` – internes Fedora/Nobara-Paket
- `open-hardware-control-3.4.29.2-INTERN-source.tar.gz` – vollständiger Quellcode-Snapshot
- `Entwicklerpaket 3.4.29.2 INTERN.zip` – vollständiger editierbarer Projektbaum einschließlich Tests, Werkzeuge und GitHub-Automatisierung

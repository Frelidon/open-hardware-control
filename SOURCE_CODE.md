...
- `open-hardware-control_3.4.28~intern2_all.deb` – internes Debian/Ubuntu/Linux-Mint-Paket
- `open-hardware-control-3.4.28-0.intern2.noarch.rpm` – internes Fedora/Nobara-Paket

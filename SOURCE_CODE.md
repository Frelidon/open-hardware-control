...
Das interne Installations-ZIP 3.4.29.9 enthält den direkt editierbaren Python-Quellcode einschließlich `desktop_shell.py`, `desktop_assets.py` und `desktop_designs.py`:
...
- `open_hardware_control_v3_4_29_9_INTERN.zip` – universelles internes Benutzerpaket
- `open-hardware-control_3.4.29.9~intern2_all.deb` – internes Debian/Ubuntu/Linux-Mint-Paket
- `open-hardware-control-3.4.29.9-0.intern2.noarch.rpm` – internes Fedora/Nobara-Paket
- `open-hardware-control-3.4.29.9-INTERN-source.tar.gz` – vollständiger Quellcode-Snapshot
- `Entwicklerpaket 3.4.29.9 INTERN.zip` – vollständiger editierbarer Projektbaum einschließlich Tests, Werkzeuge und GitHub-Automatisierung

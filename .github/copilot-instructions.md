...
Vor Änderungen vollständig `AGENTS.md`, `MODULE_REGISTRY.md`, `AI_DEVELOPMENT_GUIDE.md` und `RELEASE_BACKUP_POLICY.md` lesen und deren Pflichtreihenfolge befolgen. Das Repository ist die dauerhafte Projektquelle; Chat- oder Agentengedächtnis ist nicht maßgeblich.
...
- Die konkrete Aufbewahrungs- und Prüfregel steht in `RELEASE_BACKUP_POLICY.md`; sie gilt auch für GitHub Copilot und andere GitHub-Coding-Agenten.
- Vor Abschluss `./scripts/check_release.sh` ausführen und `MODULE_REGISTRY.md`, Projektstatus, Changelog und Release Notes passend aktualisieren.

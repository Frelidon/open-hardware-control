...
Der aktuelle Entwicklungsstand ist in `PROJECT_STATUS.md` beschrieben. Version 3.4.29.6 INTERN umfasst unter anderem das Thermalright-Levita-Display-Studio mit echtem verstellbarem Notch-Balken, Hintergrund-X/Y und Abstandsvorlagen, die sicher bestätigungspflichtige Levita-Pumpen-/Radiatorsteuerung mit prozessgebundener Polkit-Helfersitzung, den zweistufigen ENE-DRAM-Kaltstart, die CoolerControl-Dienstverwaltung, die bereinigte Thermalright-/NZXT-Startauswahl und den ersten kompatiblen Schnitt der historischen Hauptdatei in fokussierte Module.

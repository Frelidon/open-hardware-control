# Open Hardware Control 3.4.29.7 INTERN – Veröffentlichung derzeit gesperrt
...
- `open-hardware-control_3.4.29.7~intern2_all.deb`
- `open-hardware-control-3.4.29.7-0.intern2.noarch.rpm`
- `open-hardware-control-3.4.29.7-INTERN-source.tar.gz`
- `Entwicklerpaket 3.4.29.7 INTERN.zip`
- `Open_Hardware_Control_3.4.29.7_INTERN_LOCAL_AI.gitbundle`
- `SHA256SUMS`
...
```bash
git tag -a v3.4.29.7 -m "Open Hardware Control v3.4.29.7"
git push origin v3.4.29.7
```

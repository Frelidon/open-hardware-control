# Open Hardware Control 3.4.28 INTERN – Veröffentlichung derzeit gesperrt
...
- `open-hardware-control_3.4.28~intern2_all.deb`
- `open-hardware-control-3.4.28-0.intern2.noarch.rpm`
- `open-hardware-control-3.4.28-INTERN-source.tar.gz`
- `Entwicklerpaket 3.4.28 INTERN.zip`
- `Open_Hardware_Control_3.4.28_INTERN_LOCAL_AI.gitbundle`
- `SHA256SUMS`
...
```bash
git tag -a v3.4.28 -m "Open Hardware Control v3.4.28"
git push origin v3.4.28
```

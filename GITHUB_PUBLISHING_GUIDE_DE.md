# Open Hardware Control 3.4.29.43 STABLE – GitHub-Veröffentlichung
...
- `open_hardware_control_v3_4_29_43.zip`
- `open-hardware-control_3.4.29.43_all.deb`
- `open-hardware-control-3.4.29.43-1.noarch.rpm`
- `open-hardware-control-3.4.29.43-source.tar.gz`
- `Entwicklerpaket 3.4.29.43.zip`
- `Open_Hardware_Control_3.4.29.43_LOCAL_AI.gitbundle`
- `SHA256SUMS`
...
git tag -a v3.4.29.43 -m "Open Hardware Control v3.4.29.43"
git push origin v3.4.29.43
```

Der Workflow `.github/workflows/release.yml` wiederholt die Tests, baut sämtliche Artefakte aus genau diesem Tag und erstellt den öffentlichen Release mit `docs/RELEASE_NOTES_v3.4.29.43.md`.

Kontrolle:

```bash
gh release view v3.4.29.43 --web
```

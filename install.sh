...
install -m 0644 "$SOURCE_DIR/docs/project/PROJECT_SCOPE.md" "$APP_DIR/PROJECT_SCOPE.md"
install -m 0644 "$SOURCE_DIR/docs/project/PROJECT_SCOPE.en.md" "$APP_DIR/PROJECT_SCOPE.en.md"
install -m 0644 "$SOURCE_DIR/docs/hardware/CPU_PROFILES.md" "$APP_DIR/CPU_PROFILES.md"
install -m 0644 "$SOURCE_DIR/docs/hardware/CPU_PROFILES.en.md" "$APP_DIR/CPU_PROFILES.en.md"
install -m 0644 "$SOURCE_DIR/docs/project/COMPONENT_VERSIONS.md" "$APP_DIR/COMPONENT_VERSIONS.md"
install -m 0644 "$SOURCE_DIR/docs/hardware/ANIMATED_BACKGROUNDS.md" "$APP_DIR/ANIMATED_BACKGROUNDS.md"
install -m 0644 "$SOURCE_DIR/docs/hardware/PROFILES.md" "$APP_DIR/PROFILES.md"
install -m 0644 "$SOURCE_DIR/docs/project/FEATURES_BY_VERSION.md" "$APP_DIR/FEATURES_BY_VERSION.md"
install -m 0644 "$SOURCE_DIR/docs/project/MODULE_REGISTRY.md" "$APP_DIR/MODULE_REGISTRY.md"
install -m 0644 "$SOURCE_DIR/docs/project/SOURCE_CODE.md" "$APP_DIR/SOURCE_CODE.md"
install -m 0644 "$SOURCE_DIR/docs/project/Kraken_Control_Projekt.md" "$APP_DIR/Kraken_Control_Projekt.md"
install -m 0644 "$SOURCE_DIR/docs/project/Open_Hardware_Control_Projekt.md" "$APP_DIR/Open_Hardware_Control_Projekt.md"
install -m 0644 "$SOURCE_DIR/docs/hardware/OPENLINKHUB_INTEGRATION.md" "$APP_DIR/OPENLINKHUB_INTEGRATION.md"
install -m 0644 "$SOURCE_DIR/docs/hardware/RGB_STUDIO.md" "$APP_DIR/RGB_STUDIO.md"
install -m 0644 "$SOURCE_DIR/docs/security/RGB_SECURITY_AUDIT.md" "$APP_DIR/RGB_SECURITY_AUDIT.md"
install -m 0644 "$SOURCE_DIR/docs/hardware/DESKTOP_DESIGNS.md" "$APP_DIR/DESKTOP_DESIGNS.md"
install -m 0644 "$SOURCE_DIR/docs/security/DESKTOP_SECURITY_AUDIT.md" "$APP_DIR/DESKTOP_SECURITY_AUDIT.md"

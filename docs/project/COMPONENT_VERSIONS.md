# Komponenten- und Versionsübersicht – Version 3.4.29.46

## Getestete Referenzkonfiguration

| Komponente | Version / Stand |
|---|---|
| Open Hardware Control by Frelidon | 3.4.29.46 STABLE |

# Komponenten- und Versionsübersicht – Version 3.4.29.48

## Getestete Referenzkonfiguration

| Komponente | Version / Stand |
|---|---|
| Open Hardware Control by Frelidon | 3.4.29.48 STABLE |

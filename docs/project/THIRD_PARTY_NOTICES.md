...
| TiledScreen | Security/licence reference only; no upstream code or asset is bundled | https://github.com/kavinunethsara/tiledscreen | LGPL-2.1-or-later; audited commits are recorded in `../security/DESKTOP_SECURITY_AUDIT.md` |

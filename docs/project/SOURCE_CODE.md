...
Das Installations-ZIP 3.4.29.46 enthält den direkt editierbaren Python-Quellcode einschließlich `desktop_shell.py`, `desktop_assets.py` und `desktop_designs.py`:
...
- OpenLinkHub-Moduldokumentation `../hardware/OPENLINKHUB_INTEGRATION.md`
- RGB-Studio- und Sicherheitsaudit-Dokumentation `../hardware/RGB_STUDIO.md`, `../security/RGB_SECURITY_AUDIT.md`
- historische NZXT-Moduldokumentation `Kraken_Control_Projekt.md`
- technische USB-Mitschnittauswertung `../hardware/USB_CAPTURE_FINDINGS.md`
...
- `open-hardware-control_3.4.29.46_all.deb` – Debian/Ubuntu/Linux-Mint-Paket
- `open-hardware-control-3.4.29.46-1.noarch.rpm` – Fedora/Nobara-Paket
- `open-hardware-control-3.4.29.46-source.tar.gz` – vollständiger Quellcode-Snapshot
- `Entwicklerpaket 3.4.29.46.zip` – vollständiger editierbarer Projektbaum einschließlich Tests, Werkzeuge und GitHub-Automatisierung
- `Open_Hardware_Control_3.4.29.46_LOCAL_AI.gitbundle` – vollständige Git-Historie für lokale KI-Arbeit

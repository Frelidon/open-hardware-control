# Entwicklerpaket 3.4.29.8 INTERN

Das Entwicklerpaket enthält:

- den vollständigen editierbaren Quellbaum von Open Hardware Control 3.4.29.8 INTERN
...
```bash
OHC_SKIP_DEB=1 ./scripts/build_release.sh 3.4.29.8
```

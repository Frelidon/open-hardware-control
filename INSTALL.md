...
Diese Anleitung gilt für **Open Hardware Control by Frelidon 3.4.29.3 INTERN**. Lade das interne Testpaket zuerst in `~/Downloads`. Diese Version ist noch nicht für ein öffentliches GitHub-Release bestimmt.
